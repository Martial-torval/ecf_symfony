...
use App\Controller\Admin\ArticlesCrudController as articlesController;
...
class DashboardController extends AbstractDashboardController
{
    ...
    public function index(): Response
    {
        ...
        return $this->redirect($adminUrlGenerator->setController(ControllerArticlesCrudController::class)->generateUrl());
